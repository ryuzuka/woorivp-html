...
<%@ include file="/WEB-INF/jsp/common/import/taglib.jspf" %>
	...
	<title>WOORI Venture Partners</title>
	...
	<link rel="stylesheet" type="text/css" href="/static/mobile/en/css/m_main.css">
	...
	<script type="text/javascript" src="/static/mobile/en/js/jquery.jscrollpane.min.js"></script>
	<script type="text/javascript" src="/static/mobile/en/js/selectbox.js"></script>
