		...
		<div class="contents">
			<div class="visualArea company">
				...
				<p role="text" class="pageTxt">
					...
					DAOL will strive to lead innovation in the financial markets, while adhering to a strict ethical code.
				</p>
			</div>
			...
			<div id="CI1T2" class="tabCont">
				...
				<div class="companyTit mtM">
					<span class="point">Subsidiaries</span> of<br>DAOL Securities
				</div>
				<div class="affArea">
					...
					<ul class="affList">
						...
						<li><a href="#pop7" role="button">DAOL Credit Service</a></li>
						<li><a href="#pop8" role="button">DAOL SAVING Bank</a></li>
						<li><a href="#pop9" role="button">DAOL New York</a></li>
					</ul>
				</div>
			</div>
			<!-- //Subsidiaries(T) -->
