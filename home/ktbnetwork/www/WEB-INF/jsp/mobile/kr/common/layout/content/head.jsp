...
<%@ include file="/WEB-INF/jsp/common/import/taglib.jspf"%>
	...
	<script type="text/javascript" src="/static/mobile/kr/js/jquery.jscrollpane.min.js"></script>
	<script type="text/javascript" src="/static/mobile/kr/js/selectbox.js"></script>
