      ...
      <div class="board_detail">
        ...
        <div class="detailCon">
          ...
          <table class="tblH">
            ...
            <tr>
              ...
              <td class="tleft">
                ...
                ② 대표이사가 제1항의 직무를 수행할 수 없는 경우에는 이사회가 정한 순위에 따라 그 이사가 소집한다. [13]<br>
              </td>
            </tr>
            <tr>
              <td class="tleft">
          ...
          <table class="tblV">
            ...
            <tr>
              <th scope="row">기타</th>
              <td>당사의 최대주주인 다올투자증권(주)이 (주)우리금융지주에 보유지분 52%
                를 매각하는 계약을 체결(23.02.27)함에 따라 계약에 따른 변경 후
                최대주주인 우리금융지주와 상기 후보자와의 관계는 ‘계열회사 직원’임</td>
            </tr>
            </tbody>
          </table>
