...
jQuery(window).load(function() {
	...
	<section class="container">
        ...
        <p role="text" class="pageTxt">다올인베스트먼트의 공지사항을 알려드립니다.</p>
			</div>
      <div class="tabType1">
        <ul>
      ...
      <div class="layerCont" tabindex="0" >
        <div class="board_detail">
          ...
          <div class="detailCon">
            ...
            <style>
              #newsDetail_pop52 .listTxt {margin-bottom:10px;}
              #newsDetail_pop52 .list li + li {margin-top:10px;}
              #newsDetail_pop52 .list li strong {display:block;}
            </style>

            <p class="tright">제정 2018.08.01.</p>
            <p class="listTxt">제1장 총 칙</p>
            <ul class="list">
              <li>
                <strong>제1조(목적)</strong>
                이 규정은 ｢자본시장과 금융투자업에 관한 법률｣(이하 “법”이라 한다) 및 제반 법규에 따른 신속, 정확한 공시 및 임원,직원의 내부자거래 방지를 위하여 주식회사 케이티비 네트워크(이하 “회사”라 한다) 내부정보의 종합관리 및 적절한 공개 등에 관한 사항을 정함을 목적으로 한다.
              </li>
              <li>
                <strong>제2조(용어의 정의)</strong>
                ① 이 규정에서 “내부정보”라 함은 한국거래소의 코스닥시장 공시규정(이하 “공시규정”이라 한다) 제1편에 의한 공시의무사항과 그 밖에 회사의 경영 또는 재산상황이나  투자자의  투자판단에 영향을 미칠 수 있는 사항을 말한다.<br>
            ...
            <p class="listTxt">제2장 내부정보의 관리</p>
            <ul class="list">
              <li>
                <strong>제4조(내부정보의 관리)</strong>
                ① 임원 및 직원은 업무상 알게 된 회사의 내부정보를 엄중히 관리하여야 하고, 업무상 필요한 경우를 제외하고는 내부정보를 사내 또는 사외에 유출하여서는 아니 된다.<br>
                ② 대표이사는 내부정보 및 그와 관련된 문서 등의 보관, 전달, 파기 등에 관한 구체적인 기준을 정하는 등 내부정보관리를 위해 필요한 조치를 취하여야 한다.
              </li>
              <li>
                <strong>제5조(공시책임자)</strong>
                ① 대표이사는 공시책임자를 정하여 이를 지체 없이 한국거래소에 신고하여야 한다. 공시책임자를 변경한 때에도 또한 같다.<br>
                ② 공시책임자는 내부정보관리제도의 수립 및 운영에 관련된 업무를 총괄하며 다음 각 호의 업무를 수행한다.<br>
                1. 공시의 집행<br>
                2. 내부정보관리제도의 운영 상황 점검 및 평가<br>
                3. 내부정보에 대한 검토 및 공시 여부의 결정<br>
                4. 임원 및 직원에 대한 교육 등 내부정보관리제도의 운영을 위해 필요한 조치<br>
                5. 내부정보의 관리를 담당하거나 공시업무를 담당하는 부서 또는 임원 및 직원에 대한 지휘 및 감독<br>
              ...
              <li>
                <strong>제6조(공시담당자)</strong>
                ① 대표이사는 공시담당자를 정하여 지체 없이 한국거래소에 신고하여야 한다. 공시담당자를 변경한 때에도 또한 같다.<br>
              ...
              <li>
                <strong>제7조(내부정보의 집중)</strong>
                ① 임원 및 주주협의회(이하 “관련부서”라 한다.)는 다음 각 호의 어느 하나에 해당하는 경우에 적시에 공시책임자에게 그에 관한 정보를 제공하여야 한다.<br>
                1. 내부정보가 발생한 경우<br>
                2. 내부정보 중 이미 공시된 사항을 취소 또는 변경해야 할 사유가 발생한 경우<br>
              ...
              <li>
                <strong>제7조의2(최대주주 관련 정보의 관리)</strong>
              ...
              <li>
                <strong>제8조(내부정보의 사외제공)</strong>
                ① 임원 및 직원이 업무상의 이유로 회사의 거래상대방, 외부 감사인, 대리인, 회사와 법률자문, 경영자문 등의 자문계약을 체결하고 있는 자 등에 대하여 불가피하게 내부정보를 제공해야 하는 경우 공시책임자에게 이에 관한 사항을 보고하여야 한다.<br>
            ...
            <p class="listTxt">제3장 내부정보의 공개</p>
            <ul class="list">
              <li>
                <strong>제9조(공시의 종류)</strong>
              ...
              <li>
                <strong>제13조의3(정보제공 요구)</strong>
                ① 주주 및 이해관계자 등으로부터 회사와 관련한 정보공개를 요구 받은 경우 공시책임자는 당해 요구의 적법성 등을 검토하여 관련 정보를 제공할 것인지 여부를 결정하여야 한다.<br>
                ② 공시책임자는 정보의 제공 여부를 결정하기 위하여 제공을 요구 받은 정보가 투자자의 투자판단 및 주가에 영향을 미칠 수 있는지 여부에 대하여 법무담당 부서 또는 외부 법률전문가 등의 의견을 청취할 수 있다.<br>
                ③ 제1항의 결정에 따라 정보를 제공하는 경우에는 제12조제3항을 준용한다.
              </li>
            </ul>
            <p class="listTxt">제4장 내부자 거래 등에 대한 규제</p>
            <ul class="list">
              <li>
                <strong>제14조(단기매매차익의 반환)</strong>
                ① 임원과 법 제172조제1항 및 법 시행령 제194조가 정하는 직원은 법 제172조제1항의 특정증권 등(이하 “특정증권 등”이라 한다)을 매수한 후 6개월 이내에 매도하거나 특정증권 등을 매도한 후 6개월 이내에 매수하여 이익을 얻은 경우에 그 이익(이하 “단기매매차익”이라 한다)을 회사에 반환하여야 한다.<br>
                ...
                ③ 증권선물위원회가 제1항에 따른 단기매매차익의 발생사실을 회사에 통보한 경우 공시책임자는 지체 없이 다음 각 호의 사항을 회사의 인터넷 홈페이지에 공시하여야 한다. 단, 회사가 합병을 완료할 때 까지는 NH투자증권 주식회사의 홈페이지에 공시를 요청 할 수 있다.<br>
                1. 단기매매차익을 반환해야 할 자의 지위<br>
                2. 단기매매차익 금액<br>
                3. 증권선물위원회로부터 단기매매차익 발생사실을 통보 받은 날<br>
                4. 단기매매차익 반환 청구 계획5. 회사의 주주가 회사로 하여금 단기매매차익을 얻은 자에게 단기매매차익의 반환청구를 하도록 요구할 수 있으며, 회사가 요구를 받은 날부터 2개월 이내에 그 청구를 하지 아니하는 경우에는 그 주주는 회사를 대위(代位)하여 청구를 할 수 있다는 뜻<br>
                ④ 제3항의 공시기간은 증권선물위원회로부터 단기매매차익 발생 사실을 통보받은 날부터 2년간 또는 단기매매차익을 반환받은 날 중 먼저 도래하는 날까지로 한다.
              </li>
              <li>
                <strong>제15조(특정증권등의 매매 등에 대한 통보)</strong>
                임원과 법 제172조제1항 및 법 시행령 제194조가 정하는 직원은 특정증권등의 매매, 그 밖의 거래를 하는 경우 그 사실을 공시책임자에게 통보하여야 한다.
              </li>
              <li>
                <strong>제16조(미공개중요정보의 이용행위 금지)</strong>
                임원 및 직원은 법 제174조제1항이 정하는 미공개중요정보(계열회사의 미공개중요정보를 포함한다)를 특정증권등의 매매, 그 밖의 거래에 이용하거나 타인에게 이용하게 해서는 아니 된다.
              </li>
            </ul>
            <p class="listTxt">제5장 보 칙</p>
            <ul class="list">
              <li>
                <strong>제17조(교육)</strong>
                ① 공시책임자와 공시담당자는 공시규정 제36조 및 제44조제5항에 따른 공시업무에 관한 교육 등을 이수하여야 하고, 공시책임자는 교육내용을 관련 임원 및 직원에게 알려야 한다.<br>
                ② 대표이사는 임원 및 직원에게 제14조부터 제16조까지의 사항 및 기타 법이 정하는 내부자거래 등을 예방하기 위한 교육의 실시 등 충분한 노력을 하여야 한다.
              </li>
              <li>
                <strong>제18조(규정의 개폐)</strong>
                이 규정의 개정 또는 폐지는 대표이사가 한다.
              </li>
              <li><strong>제19조(규정의 공표)</strong>
                이 규정은 회사의 홈페이지 등에 공표한다. 규정을 개정한 때에도 또한 같다.
              </li>
            </ul>
