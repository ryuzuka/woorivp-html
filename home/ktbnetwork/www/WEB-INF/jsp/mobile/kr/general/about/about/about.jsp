	...
	<div class="layerPop" id="pop2">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				...
				‘99년 설립되어 20여년간 지속 성장하고 있는 
				중견 종합자산운용사로 ‘19년말 기준 총 운용자산
				(AUM)은 12.5조원*에 달하고 있습니다. 
				특히, 2016년 멀티에셋본부, 대체투자부문 
				신설을 통해 신규 비즈니스에서 두각을 나타내고
				있습니다.<br><br>
				1등주 펀드, 코스닥벤처펀드, 코넥스하이일드
				펀드 등 다수의 HIT 공모펀드를 출시 및 운용하여 
				시장의 선도적인 역할을 수행하고 있으며, 
				EMP/NPL/자산배분형 등 중위험 · 중수익 상품 
				출시를 지속 확대하고 있습니다.
				<br><br>
				대체투자부문은 ‘19년 전세계 핵심 상업지구에서
				1.3조원 규모의 딜을 성사시켰으며, ‘19년말 기준
				총 3.7조원의 대체투자자산을 운용하고 있습니다.
				<br><br>
				<p class="info">2019년말 기준, 금융투자협회</p>
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
	</div>
	...
	<div class="layerPop" id="pop3">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				...
				국내 최고 수준의 업력 및 투자경험을 보유한 
				한국을 대표하는 벤처캐피탈입니다.
				‘19년말 현재 보유 중인 운용자산(AUM)은 
				약 8,835억원*이며, 작년 한해 신규로 결성된 
				펀드 규모는 약정액 기준 약 100억원입니다.<br><br>
				...
				확보하고 있습니다.
				<br><br>
				<p class="info">2019.12월말 기준, PEF 포함</p>
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
	</div>
	...
	<div class="layerPop" id="pop7">
		<div class="layerContainer">
			...
			<div class="layerCont" tabindex="0">
				...
				<p class="txtGuide">예금보험공사 채권 수임기간 : ‘01년 ~ ‘20년 3월 현재</p>
			</div>
		</div>
		<button type="button" class="layerClose">닫기</button>
	</div>
