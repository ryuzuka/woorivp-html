  ...
  <div class="content">
    ...
    <div class="inner">
      <div class="boardView">
        ...
        <div class="viewCon">
          <h3 style="text-align: center">우리벤처파트너스 지점 설치관련 인테리어 공사업체 선정 공고</h3>
          <br>
          <table class="tblV">
          ...
          <div class="noticeBox">
            상기와 같이 입찰공지합니다.
            <span class="dateTxt">2023년 05월 02일</span>
            <br>
            <strong class="ceoTxt">우리벤처파트너스㈜ 경영지원그룹</strong>
					...
					<ul class="baordIndex">
						<li>
							<a href="/home/info/notice/view.do?page=3&num=57">
								<div class="arrow prev">이전글</div>
								<div class="tit">제 15기 결산공고</div>
							</a>
						</li>
					</ul>
					<div class="btnArea">
