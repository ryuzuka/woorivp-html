			...
			<div class="content">
				...
				<div class="inner">
					...
					<div class="Philosophy">
						...
						<div class="conArea">
							<ul>
								<li><strong>Active Value Creation</strong>투자업체 지원 및 가치창출 활동을 통해 지속 가능한 성장도모, 투자업체 성공과 목표수익 달성</li>
					...
					<p class="txtInfo">우리벤처파트너스의 투자는 어느 한 기업의 성장 단계에 국한되지 않습니다. 기업들이 사업모델을 구상하고, 시장과 소통하며 지속적으로 성장할 수 있도록 지원하고 그 안에서의 가치를 찾는 역할을 하겠습니다. </p>
					...
					<ul class="plopList">
						...
						<li><img src="/static/home/kr/images/contents/ico_philosophy02.png" alt=""><span>Growth</span></li>
						<li><img src="/static/home/kr/images/contents/ico_philosophy03.png" alt=""><span>Late</span></li>
						<li><img src="/static/home/kr/images/contents/ico_philosophy04.png" alt=""><span>Pre-IPO</span></li>
						<li><img src="/static/home/kr/images/contents/ico_philosophy05.png" alt=""><span>PIPE</span></li>
					</ul>
					<h3 class="titDep2">SECTORS</h3>	
					<p class="txtInfo">우리벤처파트너스는 모든 분야에서 기회를 찾습니다. 수년간 콘텐츠 및 엔터테인먼트, ICT, 교육, Bio, Healthcare등의 분야에서 새로운 기회 및 경험, 전문성을 쌓아나가고 있습니다.</p>
