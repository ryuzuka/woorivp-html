				...
				<div class="inner">
					<div class="boardView">
						...
						<div class="viewCon">
							...
							당사는 상법 제363조와 정관 제 19조 및 21조에 의거 제 14 기 정기주주총회를 아래와 같이 개최 하오니 참석하여 주시기 바랍니다.
							<table class="tblV">
							...
							<div class="noticeBox">
								위와 같이 공고합니다.
								<span class="dateTxt">2022년 03월 07일</span>
								<p>경기도 성남시 분당구 대왕판교로670유스페이스2A동 10층 (☏070-4377-2000)</p>
								<strong class="ceoTxt">케이티비네트워크 주식회사 대표이사 김창규</strong>
							</div>
							<h2 class="titDep3">정관변경(안)</h2>
							<table class="tblH">
								<caption>정관변경(안)</caption>
								<colgroup><col style="width:43%"><col style="width:43%"><col style="width:14%"></colgroup>
								<thead>
								<tr>
									<th scope="col">현 행</th>
									<th scope="col">변 경</th>
