...
<%@ include file="/WEB-INF/jsp/common/import/taglib.jspf" %>
		...
		<section id="container" class="container">
			<nav class="nav">
				<ol class="navArea"><li>HOME</li><li>About 우리금융그룹</li></ol>
			</nav>
			<div class="content">
				...
				<div class="inner">
					<h2 class="hidden">About 우리금융그룹</h2>
					<div class="aboutGroup">
						<p class="txtCopy">우리금융그룹은 고객에게 <br />
              다양한 금융서비스를 제공하고 있습니다.</p>

						<div class="tabCont on">
							<h3 class="hidden">계열사</h3>
							<div class="subsidiary">
								<div class="imgArea"><img src="/static/home/kr/images/contents/img_woorigroup.png" alt="우리금융그룹 금융그룹 계열사"></div>
								<ul class="list">
									<li>
                      ...
                      우리금융지주의 자회사인 우리종합금융은 국내 유일의 종합금융회사입니다. 우리종합금융은 종합금융회사의 다양한 라이선스와 우리금융그룹의 신인도 및 네트워크를 활용한 업그레이드된 상품과 서비스로 고객님의 행복한 자산관리 파트너 역할을 수행하겠습니다. 더불어 고객님의 풍요로운 미래를 향해가는 동반자로 자리매김하기 위해 최선을 다할 것을 약속드립니다.
									...
									<li>
										<div class="subsidiaryName">
                      <p class="group_name">우리자산신탁</p>
                      <p class="group_deac">종합부동산금융 One-Stop Service 제공을 통한<br />
                      ...
                      <p class="group_deac">선진금융을 선도하는<br />
									...
									<li>
										...
										<p class="txt">
											우리펀드서비스는 집합투자기구의 펀드회계처리 및 기준가격 산출, 부동산 투자회사의 다양한 일반사무관리를 제공하는 회사입니다. 또한, 국내 최초로 「디지털자산기업회계솔루션『DABAS』시스템」, 「디지털자산 전자공시 플랫폼」을 개발하는 등 디지털자산 사무관리시장에 진출하여 변화하는 금융시장을 선도하고 있습니다. 우리펀드서비스는 대한민국 대표 사무관리회사로 도약하기 위해 지속적인 시스템 개발 및 인재 육성을 위하여 노력하고 끊임없이 혁신하고 연구해 나가겠습니다.
										</p>
									</li>
									<li>
										<div class="subsidiaryName">
