			...
			<div class="content">
				<div class="visualArea">
					<div class="inner">
						...
						<p class="pageTxt">내일을 보는 금융, 다올금융그룹을 소개합니다.</p>
					</div>
				</div>
				...
				<div class="inner">
					...
					<div class="aboutGroup">
						...
						<p class="subTxt">
							다올금융그룹은 1981년 정부가 출자한 한국기술개발을 모태로 출발했습니다.
							<br>이제 다올은 증권, 자산운용, 저축은행, 벤처캐피탈, 프라이빗에쿼티 등 금융 전반을 아우르는 그룹으로 성장했습니다.
							<br>또한 미국, 중국, 태국 등 해외 시장에 적극적으로 진출하여 글로벌 네트워크를 확대하고 있습니다.
							<br>앞으로도 다올금융그룹의 모든 임직원은 오직 고객의 더 큰 성공을 위해 혁신을 선도하고, 윤리 원칙을 준수하며 고객의 신뢰를 쌓아가겠습니다.
						</p>
						<div class="imgArea"><img src="/static/home/kr/images/contents/img_worldmap.jpg" alt="다올 금융그룹 활동영역 세계지도"></div>
						...
						<div class="tabCont">
							...
							<div class="subsidiary">
								<div class="imgArea"><img src="/static/home/kr/images/contents/img_affiliates_v2.jpg" alt="다올 금융그룹 계열사"></div>
								<ul class="list">
									<li>
									...
									<li>
										...
										<p class="txt">
											‘12년 다올투자증권 PE 부문을 분사하여 설립된 누적운용자산 2조원 규모의 사모투자펀드 운용사입니다.<br>
									...
									<li>
										...
										<p class="txt">
											‘99년 나라신용정보로 출발한 다올신용정보는 ‘01년 다올투자증권의 계열사로 편입되었습니다.<br>
									...
									<li>
										...
										<p class="txt">
											‘08년 8월 다올투자증권이 인수한 태국 현지 증권사입니다.<br>
