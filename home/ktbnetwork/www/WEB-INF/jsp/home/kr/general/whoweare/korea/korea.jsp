						...
						<ul>
							...
							<li>
								<div class="member">
									...
									<div class="right">
										<h3>김혜성 <span class="pointColor">KOREA / 투자팀 / 대리</span></h3>
										<dl>
											<dt>주요경력</dt>
							...
							<li>
								<div class="member">
									...
									<div class="right">
										<h3>김만식 <span class="pointColor">KOREA / 투자팀 / 대리</span></h3>
										<dl>
											<dt>주요경력</dt>
                    ...
                    <strong>이지은</strong> 팀장
								...
								<li>
									<div class="member">
										...
										<div class="right">
											<h3>정가영 <span class="pointColor">KOREA / 관리팀 / 주임</span></h3>
											<dl>
												<dt>주요경력</dt>
												<dd>이트너스</dd>
												<dt>업무</dt>
