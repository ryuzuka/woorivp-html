              ...
              <strong>김창규</strong> 대표이사
					...
					<li>
						...
						<a href="#" class="thumb">
							...
							<strong>이승호</strong> 전무
						</a>
					</li>
					<li>
						<div class="member">
							<div class="left"><img src="/static/home/kr/images/contents/img_team04.jpg" alt="현"></div>
							<div class="right">
					...
					<li>
						<div class="member">
							...
							<div class="right">
								<h3>김은숙 <span class="pointColor">KOREA / 투자팀 / 이사</span></h3>
								<dl>
									<dt>주요경력</dt>
					...
					<li>
						<div class="member">
							...
							<div class="right">
								<h3>장성엽 <span class="pointColor">KOREA / 투자팀 / 이사</span></h3>
								<dl>
									<dt>주요경력</dt>
					...
					<li>
						<div class="member">
							...
							<div class="right">
								<h3>천지웅 <span class="pointColor">KOREA / 투자팀 / 이사</span></h3>
								<dl>
									<dt>주요경력</dt>
						...
						<li>
							<div class="member">
								...
								<div class="right">
									...
									<dl>
										<dt>주요경력</dt>
										<dd>고려대학교 경제학과<br>벤더빌트대 대학원 경제학 석사<br>기획재정부<br>주미국 대한민국 대사관<br>국제통화기금(IMF)<br>한국은행
									</dl>
								</div>
							</div>
							<a href="#" class="thumb">
						...
						<li>
							<div class="member">
								...
								<div class="right">
									...
									<dl>
										<dt>주요경력</dt>
										<dd>삼일회계법인<br>행복마루법률사무소&amp;컨설팅<br>다올투자증권</dd>
										<dt>업무</dt>
										<dd>경영기획 및 회계</dd>
									</dl>
								</div>
            ...
            <li>
              ...
              <a href="#" class="thumb">
                ...
                <strong>추상훈</strong> 대리
						...
						<li>
							<div class="member">
								<div class="left"><img src="/static/home/kr/images/contents/img_team55.jpg" alt="고명주"></div>
								<div class="right">
									<h3>고명주 <span class="pointColor">KOREA / 관리팀 / 사원</span></h3>
									<dl>
										<dt>주요경력</dt>
										<dd>경기창조경제혁신센터</dd>
										<dt>업무</dt>
							...
							<a href="#" class="thumb">
								<span class="img"><img src="/static/home/kr/images/contents/thumb_team55_off.jpg" alt="고명주"></span>
								<strong>고명주</strong> 사원
							</a>
						</li>
						<li>
							<div class="member">
